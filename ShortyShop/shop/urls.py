...
from .views import  category_view ,about, home, products, product_detail, cart, add_product, edit_product, delete_product, product_list, add_to_cart, remove_from_cart, update_cart, checkout_mercadopago, pago_fallido, pago_exitoso
